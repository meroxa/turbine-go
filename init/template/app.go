...
func (a App) Run(v turbine.Turbine) error {
	...
	// If a configuration is needed, it would look like
	// []turbine.ResourceConfig{{Field: "incrementing.field.name", Value: "id"}}
	...
	//   res,
	//   "my-archive",
	//   []turbine.ResourceConfig{{Field: "buffer.flush.time", Value: "10"}})
